...
const DEPOSIT_VK_IDENTIFIER: VerificationKeyIdentifier = [b'd', b'd', b'e', b'p', b'o', b's', b'i', b't'];
/// Verification key identifier for the `deposit` relation (to be registered in `pallet_snarcos`).
const DEPOSIT_AND_MERGE_VK_IDENTIFIER: VerificationKeyIdentifier = [b'd', b'e', b'p', b'o', b'n', b'm', b'r', b'g'];
/// Verification key identifier for the `withdraw` relation (to be registered in `pallet_snarcos`).
const WITHDRAW_VK_IDENTIFIER: VerificationKeyIdentifier = [b'w', b'i', b't', b'h', b'd', b'r', b'a', b'w'];
